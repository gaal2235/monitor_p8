...
class MonitorFilterGet {
  static Future<List<Monitor>> getMonitorFilter(
      ...
      String plate = ""}) async {
    var url =
        'http://172.40.1.7:7903/rest/AUDITORIAS/MONITOR?DATADE=$dateInit&DATAATE=$dateEnd&FILIALDESTINO=$dropdownValue&RECEBIDO=$received&CONFERIDO=$checked&ENDERECADO=$addressed&PORTARIA=$concierge&ROMANEIO=$gfe&PLACAVEICULO=$plate';
